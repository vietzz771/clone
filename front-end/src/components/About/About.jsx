        ...
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className='w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2'>
            ...
            <p className='text__para mt-[30px]'>
              ...
              patients-not looking back at what we accomplished but towards what we can do
              tomorrow. Providing the best. Lorem ipsum dolor sit amet, consectutur
              adipiscing elit. Aliquid, modi?
            </p>
            <Link to='/'>
