            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit asperiores quos inventore, adipisci debitis excepturi doloribus. Ratione minima
                  necessitatibus, facere error itaque sapiente, natus, ab nostrum fugit iste nemo ducimus.
                </p>
      ...
      <section>
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">Wold-class care for everyone. Our health System offers unmatched, expert health care.</p>
          </div>
          <div
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Wold-class care for everyone. Our health System offers unmatched, expert health care. From the lab to the clinic
                </p>
                <Link
                  to="/doctors"
