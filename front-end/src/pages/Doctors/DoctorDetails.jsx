          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded"
                ...
                <h3 className="text-headingColor text-[22px] leading-9 mt-3 font-bold">Quoc Viet</h3>
                ...
                <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed quia nemo ratione esse laborum voluptatem libero ipsum facilis repellendus quam
                  illo id vel eveniet iusto fuga laboriosam quo, alias inventore.
                </p>
              </div>
            </div>
